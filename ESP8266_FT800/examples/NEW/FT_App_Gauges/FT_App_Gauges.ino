...
FT800IMPL_SPI FTImpl(FT_CS_PIN,FT_PDN_PIN);
...
const char *infor[] = {  "FT800 Gauges Application",
...
void Info()
{
  ...
  do
  {
    ...
    //INFORMATION 
    FTImpl.Cmd_Text(FT_DISPLAYWIDTH/2,20,28,FT_OPT_CENTER,infor[0]);
    FTImpl.Cmd_Text(FT_DISPLAYWIDTH/2,60,26,FT_OPT_CENTER,infor[1]);
    FTImpl.Cmd_Text(FT_DISPLAYWIDTH/2,90,26,FT_OPT_CENTER,infor[2]);  
